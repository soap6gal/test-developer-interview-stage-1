...
public class SearchTarget {
    ...
    public final static Target JEWELLERY_SHOP_ICON = Target.the("the jewellery shop icon").located(By.xpath("//div[@class='block-grid-item' and .//a[@href='https://www.etsy.com/uk/featured/jewellery-uk?ref=hp_g']]"));
